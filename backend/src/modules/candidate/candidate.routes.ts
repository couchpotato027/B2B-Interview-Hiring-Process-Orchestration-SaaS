...
import { addCandidate, listCandidates, getCandidate, updateCandidate, deleteCandidate, moveCandidateStage, rejectCandidate, hireCandidate } from './candidate.controller';
...
router.post('/:id/transition', requireRole('ADMIN', 'RECRUITER'), moveCandidateStage);
